...
insert  into `Messages`(`user_username`,`text`,`posted_at`,`id`) values ('kris','Lunch at the shard? Sounds like more of a dinner thing','2019-08-14 11:56:45',1),('paul','What about the IC then? That\'s the 5th Oct','2019-08-14 11:57:55',2),('ben','I don\'t want to stay at the IC though, would just be a daytrip','2019-08-14 12:04:34',3),('sam','Yummy yummy chineeeese. I want some more of that lamb','2019-08-14 13:44:16',4),('kris','I should probably post a second message to test the view properly','2019-08-14 14:22:56',5),('kris','This was posted with the web form','2019-08-14 15:51:48',9),('kris','...and so was this!','2019-08-14 15:53:08',10),('hannah','We\'ve lost another parcel. Oh well, insurance will cover it','2019-08-14 16:20:42',11),('kris','I should really try with a considerably longer message, just to see what it displays like. Probably badly.','2019-08-14 17:14:40',12),('paul','I really need a second message for paul, so I wrote one.','2019-08-14 17:23:37',13);
